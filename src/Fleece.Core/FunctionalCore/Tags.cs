...
public static class Tags
{
    ...
    public static IReadOnlyList<string> ValidateTags(IReadOnlyList<string>? tags)
    {
    ...
    public static bool HasKeyedTag(Issue issue, string key, string value)
    {
    ...
    public static bool HasTagKey(Issue issue, string key)
    {
        if (issue.Tags is null || issue.Tags.Count == 0)
        {
            return false;
    ...
    public static IReadOnlyDictionary<string, IReadOnlyList<string>> GetKeyedTags(Issue issue)
    {
